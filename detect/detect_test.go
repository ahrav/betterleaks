...
let password = 'Summer2024!';`
	for name, tc := range cases {
		t.Run(name, func(t *testing.T) {
			...
			actual := d.detectFragmentWithRule(f, raw, fragmentContentKey{}, rule, []*codec.EncodedSegment{}, nil)
...
func TestWindowsFileSeparator_RulePath(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			actual := d.detectFragmentWithRule(test.fragment, test.fragment.Raw, fragmentContentKey{}, test.rule, []*codec.EncodedSegment{}, nil)
...
func TestWindowsFileSeparator_RuleAllowlistPaths(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			actual := d.detectFragmentWithRule(test.fragment, test.fragment.Raw, fragmentContentKey{}, rule, []*codec.EncodedSegment{}, nil)
			compare(t, test.expected, actual)
		})
	}
}
